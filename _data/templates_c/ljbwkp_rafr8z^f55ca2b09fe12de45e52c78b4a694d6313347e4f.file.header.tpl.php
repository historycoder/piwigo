<?php /* Smarty version Smarty-3.1.13, created on 2014-10-24 13:07:53
         compiled from ".\themes\default\template\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30961544a87697751c2-08879041%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f55ca2b09fe12de45e52c78b4a694d6313347e4f' => 
    array (
      0 => '.\\themes\\default\\template\\header.tpl',
      1 => 1402708242,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30961544a87697751c2-08879041',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_544a8769a58362_22418431',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_544a8769a58362_22418431')) {function content_544a8769a58362_22418431($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\piwigo\\include\\smarty\\libs\\plugins\\modifier.replace.php';
?><!DOCTYPE html>
...
<meta name="description" content="<?php echo $_smarty_tpl->tpl_vars['PLUG_META']->value;?>
">
<?php }else{ ?>
<meta name="description" content="<?php echo $_smarty_tpl->tpl_vars['PLUG_META']->value;?>
">
...
?> <?php if ($_smarty_tpl->tpl_vars['theme']->value['load_css']){?> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0][0]->func_combine_css(array('path'=>"themes/".((string)$_smarty_tpl->tpl_vars['theme']->value['id'])."/theme.css",'order'=>-10),$_smarty_tpl);?>
 ...
 <?php }?> <?php } ?> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0][0]->func_combine_script(array('id'=>"jquery",'load'=>"footer"),$_smarty_tpl);?>
