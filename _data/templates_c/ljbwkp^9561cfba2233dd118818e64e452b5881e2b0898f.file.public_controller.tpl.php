<?php /* Smarty version Smarty-3.1.13, created on 2014-10-24 13:07:53
         compiled from "C:\wamp\www\piwigo\plugins\AdminTools\template\public_controller.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9796544a8769b71489-05966331%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9561cfba2233dd118818e64e452b5881e2b0898f' => 
    array (
      0 => 'C:\\wamp\\www\\piwigo\\plugins\\AdminTools\\template\\public_controller.tpl',
      1 => 1408816052,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9796544a8769b71489-05966331',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_544a876a2752e2_27921108',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_544a876a2752e2_27921108')) {function content_544a876a2752e2_27921108($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\wamp\\www\\piwigo\\include\\smarty\\libs\\plugins\\function.html_options.php';
?> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0][0]->func_combine_css(array('path'=>($_smarty_tpl->tpl_vars['ADMINTOOLS_PATH']->value).('template/public_style.css')),$_smarty_tpl);?>
 ...
 <?php if (isset($_smarty_tpl->tpl_vars['ato']->value['QUICK_EDIT'])){?>  <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0][0]->func_combine_script(array('id'=>'mousetrap','load'=>'footer','path'=>($_smarty_tpl->tpl_vars['ADMINTOOLS_PATH']->value).('template/mousetrap.min.js')),$_smarty_tpl);?>
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0][0]->func_combine_css(array('id'=>'colorbox','path'=>'themes/default/js/plugins/colorbox/style2/colorbox.css'),$_smarty_tpl);?>
 <?php if (isset($_smarty_tpl->tpl_vars['ato']->value['IS_PICTURE'])){?>  <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0][0]->func_combine_script(array('id'=>'jquery.tokeninput','load'=>'footer','require'=>'jquery','path'=>'themes/default/js/plugins/jquery.tokeninput.js'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0][0]->func_combine_css(array('path'=>'themes/default/js/plugins/jquery.tokeninput.css'),$_smarty_tpl);?>
  <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0][0]->func_combine_script(array('id'=>'jquery.ui.datepicker','load'=>'footer','path'=>'themes/default/js/ui/jquery.ui.datepicker.js'),$_smarty_tpl);?>
 <?php $_smarty_tpl->tpl_vars['datepicker_language'] = new Smarty_variable((('themes/default/js/ui/i18n/jquery.ui.datepicker-').($_smarty_tpl->tpl_vars['lang_info']->value['code'])).('.js'), null, 0);?> <?php if (file_exists((constant('PHPWG_ROOT_PATH')).($_smarty_tpl->tpl_vars['datepicker_language']->value))){?> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0][0]->func_combine_script(array('id'=>('jquery.ui.datepicker-').($_smarty_tpl->tpl_vars['lang_info']->value['code']),'load'=>'footer','path'=>$_smarty_tpl->tpl_vars['datepicker_language']->value),$_smarty_tpl);?>
 <?php }?> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_css'][0][0]->func_combine_css(array('path'=>'themes/default/js/ui/theme/jquery.ui.core.css'),$_smarty_tpl);?>
 ...
 <?php }?> <?php }?> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0][0]->func_combine_script(array('id'=>'admintools.controller','load'=>'footer','require'=>'jquery','path'=>($_smarty_tpl->tpl_vars['ADMINTOOLS_PATH']->value).('template/public_controller.js')),$_smarty_tpl);?>
...
<?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['ato']->value['U_SET_REPRESENTATIVE'])){?>
...
<?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['ato']->value['U_CADDIE'])&&isset($_smarty_tpl->tpl_vars['ato']->value['IS_PICTURE'])){?>
...
<?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['ato']->value['U_ADMIN_EDIT'])){?>
...
<?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['ato']->value['U_CADDIE'])){?>
...
<?php }?>
<?php if (isset($_smarty_tpl->tpl_vars['ato']->value['IS_CATEGORY'])){?>
...
<?php  $_smarty_tpl->tpl_vars['tag'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tag']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['ato']->value['QUICK_EDIT']['tag_selection']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
